...
public class GeometryServerTest {
    ...
    public void testProjection() {
        ...
        org.epl.geometry.ProjectionTransformation projectionTransformation = new org.epl.geometry.ProjectionTransformation(SpatialReferenceEx.create(32632), SpatialReferenceEx.create(4326));
        Polyline originalPolyline = (Polyline)org.epl.geometry.OperatorProject.local().execute(polyline, projectionTransformation, null);
    ...
    public void testSpatialReferenceReturn_5() {
        ...
        GeometryRequest serviceConvexOp = GeometryRequest
                .newBuilder()
                .setLeftGeometry(geometryData)
                .setOperationSr(SpatialReferenceData.newBuilder().setProj4(SpatialReferenceEx.create(3857).getProj4()).build())
                .setOperator(OperatorType.CONVEX_HULL)
                .build();
...
//        assertEquals(geometryResponse.getMeasure(), 90000.0);
    ...
    public void testAffineTransform() {
        ...
        String wkt = GeometryEngineEx.geometryToWkt(pt, 0);
        GeometryRequest geometryRequest = GeometryRequest
                .newBuilder()
                .setGeometry(
                        GeometryData
